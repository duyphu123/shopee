          ...
          {isAuthenticated && (
            ...
            >
              <div className='mr-2 h-6 w-6 flex-shrink-0'>
                <img src='https://bom.so/ua8BxX' alt='avatar' className='h-full w-full rounded-full object-cover' />
              </div>
                    ...
                    <div className='mt-5'>
                      <div className='mt-2 flex py-2 hover:bg-gray-100'>
                        ...
                        <div className='ml-2 flex-grow overflow-hidden'>
                          <div className='truncate'>Yellow Sleeveless Mini Raw Dress</div>
                        </div>
                        <div className='ml-2 flex-shrink-0'>
                          <span className='text-orange'>₫469.999</span>
                        </div>
                      </div>
                      <div className='mt-2 flex py-2 hover:bg-gray-100'>
                        <div className='flex-shrink-0'>
